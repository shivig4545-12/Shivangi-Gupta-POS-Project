    ...
    <Card>
      ...
      <CardBody>
        <Row>
          ...
          <Col lg={6}>
            <div className="mb-3">
              <TextFormInput control={control} type="file" name="file" label="Banner 1" placeholder="" />
            </div>
          </Col>
          <Col lg={6}>
            <div className="mb-3">
              <TextFormInput control={control} type="file" name="file" label="Banner 2" placeholder="" />
            </div>
          </Col>
        </Row>
      </CardBody>
    ...
    <Card>
      ...
      <CardBody>
        <Row>
          ...
          <Col lg={6}>
            <div className="mb-3">
              <TextFormInput control={control} type="text" name="subtitle" label="Sub Title" placeholder="" />
            </div>
          </Col>
        </Row>
      </CardBody>
