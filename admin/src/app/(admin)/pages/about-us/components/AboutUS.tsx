    ...
    <Card>
      ...
      <CardBody>
        <Row>
          ...
          <Col lg={12}>
            <div className="mb-3">
              <TextFormInput control={control} type="file" name="file" label="Banner" placeholder="" />
            </div>
          </Col>
          <Col lg={6}>
            <div className="mb-3">
              <TextFormInput control={control} type="text" name="file" label="info title 1" placeholder="" />
            </div>
          </Col>
          <Col lg={6}>
            <div className="mb-3">
              <TextFormInput control={control} type="text" name="file" label="info sub-title 1" placeholder="" />
            </div>
          </Col>
          <Col lg={6}>
            <div className="mb-3">
              <TextFormInput control={control} type="text" name="file" label="info title 2" placeholder="" />
            </div>
          </Col>
          <Col lg={6}>
            <div className="mb-3">
              <TextFormInput control={control} type="text" name="file" label="info sub-title 2" placeholder="" />
            </div>
          </Col>
          <Col lg={12}>
            <div className="mb-0">
    ...
    <Card>
      ...
      <CardBody>
        <Row>
          ...
          <Col lg={6}>
            <div className="mb-3">
              <TextFormInput control={control} type="file" name="metaTag" label="Founder Image" placeholder="" />
            </div>
          </Col>
          <Col lg={6}>
            <div className="mb-3">
              <TextFormInput control={control} type="text" name="metaTag" label="Founder Name" placeholder="" />
            </div>
          </Col>
          <Col lg={6}>
            <div className="mb-3">
              <TextFormInput control={control} type="text" name="metaTag" label="Founder Designation" placeholder="" />
            </div>
          </Col>
          <Col lg={12}>
            <div className="mb-0">
    ...
    <Card>
      ...
      <CardBody>
        <Row>
          ...
          <Col lg={6}>
            <div className="mb-3">
              <TextFormInput control={control} type="text" name="metaTag" label="Sub Title" placeholder="" />
            </div>
          </Col>
          <Col lg={6}>
            <div className="mb-3">
              <TextFormInput control={control} type="file" name="metaTag" label="ISO Certificatie" placeholder="" />
            </div>
          </Col>
          <Col lg={6}>
            <div className="mb-3">
              <TextFormInput control={control} type="file" name="metaTag" label="Banner 1" placeholder="" />
            </div>
          </Col>
          <Col lg={6}>
            <div className="mb-3">
              <TextFormInput control={control} type="file" name="metaTag" label="Banner 2" placeholder="" />
            </div>
          </Col>
          <Col lg={6}>
            <div className="mb-3">
              <TextFormInput control={control} type="file" name="metaTag" label="Banner 3" placeholder="" />
            </div>
          </Col>
          <Col lg={12}>
            <div className="mb-0">
